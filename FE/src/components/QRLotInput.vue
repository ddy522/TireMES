...
<template>
  <div class="flex gap-2">
    ...
    <button class="btn-primary" @click="handleSubmit">{{ buttonText }}</button>
  </div>
...
const props = defineProps({
  placeholder: {
    type: String,
    default: 'LOT 번호를 입력/스캔하세요 (예: LOT-W0001-001)'
  },
  buttonText: {
    type: String,
    default: '등록'
...
const lotInput = ref(props.modelValue)
